...
import com.project.blogapi.blogapi.services.FileService;
...
public ApiResponse deletePost(@PathVariable Integer postId){
   ...
   return new ApiResponse("Post is succussfully deleted !!",true);
}
//update post
...
public ResponseEntity<List<PostDto>> searchPostById(
  ...
  public ResponseEntity<PostDto> uploadPostImage(@RequestParam("image") MultipartFile image , @PathVariable Integer postId) throws IOException{
      String fileName=  this.fileService.uploadeImage(path,image);
